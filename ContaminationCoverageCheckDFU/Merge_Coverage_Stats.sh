...
outputfile="/home/acampbe/DFU/data/AlignmentCoverage/CompleteCoverageData/AllCoverageStats.tsv"

echo "identifer    length    mapped    placed    min_cov    max_cov    mean_cov" > $outputfile


for dornfile in /home/acampbe/DFU/data/AlignmentCoverage/CompleteCoverageData/CoverageStatsContigTSVs/*.tsv ; do
