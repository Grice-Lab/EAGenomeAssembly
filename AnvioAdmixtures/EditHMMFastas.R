...
# Hybrid assemblies 
###################
c("SecY", "SmpB", "SecG", "PGK", "SecE", "Ribosom_S12_S23", "Ribosomal_S7", "Ribosomal_L1", "tRNA-synt_1d", "Ribosomal_L32p", "Ribosomal_S9", "Ribosomal_S6", "Ribosomal_L13", "Pept_tRNA_hydro")
