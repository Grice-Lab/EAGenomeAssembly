...
library(dplyr)
setwd("/Users/amycampbell/Desktop/GriceLabGit/EAGenomeAssembly/CoverageAnalyses/DFU_Coverage/")

BCFOutput = read.csv("BCF_output_stats.csv")
...
DFUisolatesInfo = read.csv("/Users/amycampbell/Desktop/GriceLabGit/DFUStrainsWGS/data_old/DFU_Staph_aureus_isolates.csv")
...
write.csv(DFUisolatesInfo_Subset, file = "ContaminatedIsolates2-12-21.csv")
